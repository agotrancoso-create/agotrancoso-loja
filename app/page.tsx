...
export default function HomePage() {
  ...
  return (
    <div className="bg-areia">
      ...
      <section className="category-row max-w-content mx-auto px-5 md:px-10">
        ...
        <section className="collection-more">
          <div className="max-w-content mx-auto px-5 md:px-10">
            <div className="section-heading">
              <div><p className="eyebrow mb-3">Mais da coleção</p><h2 className="section-title">Peças para decorar, presentear e guardar memórias.</h2></div>
      ...
      <section className="bg-areia">
        <div className="max-w-content mx-auto px-5 md:px-10">
          <div className="max-w-lg">
            ...
            <p className="editorial-copy">Objetos artesanais para criar ambientes com calor, memória e personalidade.</p>
            <Link href="/produtos" className="inline-flex mt-8 bg-marrom text-areia px-7 py-4 font-bold uppercase tracking-[.16em]">Escolher uma peça</Link>
          </div>
          <div className="editorial-image"><img src="/complementar.jpg" alt="Igrejinhas luminárias em cerâmica" loading="lazy" /></div>
        </div>
      </section>

      <section className="how-section text-marrom">
        <div className="max-w-content mx-auto px-5 md:px-10">
          <div><p className="eyebrow mb-4">Como comprar</p><h2>Escolha sua peça,<br />com calma.</h2></div>

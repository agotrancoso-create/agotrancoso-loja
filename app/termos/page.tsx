  ...
  return (
    <div className="legal-page">
      <div className="legal-shell legal-content">
        ...
        <section><h2>4. Benefício de primeira compra</h2><p>O código da oferta fica salvo neste navegador. A elegibilidade é verificada no checkout com o e-mail e o telefone informados no pedido. O desconto só é aplicado após essa validação.</p></section>

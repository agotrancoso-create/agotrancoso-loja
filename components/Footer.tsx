    ...
    <footer className="bg-marrom text-areia mt-24">
      <div className="max-w-content mx-auto px-5 md:px-8 pt-14 pb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          <div>
            <h3 className="font-serif text-2xl mb-3">Agô Trancoso</h3>
            <p className="text-sm text-areia/80 leading-relaxed font-sans max-w-sm">Cerâmicas, lembranças e detalhes especiais para decorar, presentear e guardar memórias.</p>
            <p className="text-xs text-areia/60 leading-6 mt-4">Frete fixo de R$ 39,90. Compras acima de R$ 500 têm frete grátis.</p>
          </div>

          <div className="font-sans text-sm">
            <h4 className="uppercase tracking-wide text-xs text-areia/60 mb-3">Navegação</h4>
            <ul className="space-y-2">
              <li><Link href="/produtos" className="hover:text-areia/70 transition-colors">Coleção</Link></li>
              <li><Link href="/nossa-essencia" className="hover:text-areia/70 transition-colors">Nossa essência</Link></li>
              <li><Link href="/contato" className="hover:text-areia/70 transition-colors">Contato</Link></li>
            </ul>
          </div>

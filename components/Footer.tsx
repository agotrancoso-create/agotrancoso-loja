    ...
    <footer className="bg-marrom text-areia">
      <div className="max-w-content mx-auto px-5 md:px-8 pt-14 pb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          <div><h3 className="font-serif text-2xl mb-3">Agô Trancoso</h3><p className="text-sm text-areia/80 leading-relaxed font-sans max-w-sm">Atendimento pelo Instagram, WhatsApp e presencialmente no Quadrado de Trancoso.</p><p className="text-xs text-areia/60 leading-6 mt-4">Frete fixo de R$ 39,90; grátis acima de R$ 500.</p></div>
          ...
          <div className="font-sans text-sm"><h4 className="uppercase tracking-wide text-xs text-areia/60 mb-3">Fale com a gente</h4><p className="text-sm text-areia/70 leading-relaxed mb-3">Peças para decorar, presentear e guardar.</p><ul className="space-y-2"><li><a href={INSTAGRAM_URL} target="_blank" rel="noopener noreferrer" className="hover:text-areia/70 transition-colors">@{INSTAGRAM_HANDLE}</a></li><li><a href={whatsappLink('Olá! Vim pelo site da Agô Trancoso.')} target="_blank" rel="noopener noreferrer" className="hover:text-areia/70 transition-colors">WhatsApp</a></li><li className="text-areia/60">{SITE_DOMAIN_LABEL}</li></ul></div>
        </div>
      </div>

    ...
    <footer className="site-footer bg-marrom text-areia">
      <div className="footer-shell">
        ...
        <div className="footer-grid">
          ...
          <div><h4>Fale com a gente</h4><ul><li><a href={INSTAGRAM_URL} target="_blank" rel="noopener noreferrer">@{INSTAGRAM_HANDLE}</a></li><li><a href={whatsappLink('Olá! Vim pelo site da Agô Trancoso.')} target="_blank" rel="noopener noreferrer">WhatsApp</a></li><li>{SITE_DOMAIN_LABEL}</li></ul></div>
        </div>
      </div>
      <div className="footer-copyright">© 2026 Agô Trancoso. Todos os direitos reservados.</div>
    </footer>
  );
}

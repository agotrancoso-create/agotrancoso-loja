    ...
    <footer className="site-footer" aria-label="Rodapé">
      <div className="site-container footer-top">
        <div className="footer-brand">
          ...
          <h2>Objetos para guardar perto o que ficou na memória.</h2>
          <p>Peças de cerâmica feitas à mão, inspiradas pela paisagem, pela arquitetura e pelos símbolos que atravessam Trancoso.</p>
        </div>

      ...
      <div className="ago-footer-wrap">
        <div className="ago-footer-main">
          <div className="ago-footer-brand">
            ...
            <h2>Agô Trancoso</h2>
            <p className="ago-footer-description">Trancoso é o começo. A coleção segue por casa, fé, presentes e outros símbolos brasileiros.</p>
          </div>
          ...
          <div className="ago-footer-group ago-footer-visit-group">
            ...
            <a href={MAPS_URL} target="_blank" rel="noopener noreferrer" className="ago-footer-map-link">Abrir no Google Maps <span aria-hidden="true">↗</span></a>
            <a href={whatsappLink('Olá! Gostaria de consultar um envio internacional da Agô Trancoso.')} target="_blank" rel="noopener noreferrer">Envio internacional sob consulta</a>
          </div>
        </div>

const benefits = [
  ...
  { title: 'inspiração brasileira', text: 'cores, formas e símbolos da nossa terra.', icon: <svg viewBox="0 0 48 48" aria-hidden="true"><path d="M24 7v34M7 24h34M12 12l24 24M36 12L12 36"/><circle cx="24" cy="24" r="4"/></svg> },

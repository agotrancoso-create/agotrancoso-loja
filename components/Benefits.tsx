const benefits = [
  {
    ...
    icon: (
      <svg viewBox="0 0 48 48" aria-hidden="true">
        <path d="M16 35c-2-6-2-12 0-17 1-3 3-5 5-5 2 0 3 2 2 5l-1 5" />
        <path d="M32 35c2-6 2-12 0-17-1-3-3-5-5-5-2 0-3 2-2 5l1 5" />
        <path d="M17 34c1 5 5 8 9 8s8-3 9-8" />
        <path d="M20 26c2-2 6-2 8 0" />
      </svg>
    ),
  },
  {

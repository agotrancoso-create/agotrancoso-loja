const benefits = [
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 64 64" aria-hidden="true">
        <path d="M26 5.5 34 7l4.5 4.2 6.4.9 2.2 5.5 5.1 3.6-.7 6.1 3 5.2-3.4 5.4-.3 6.1-5.8 1.7-3.5 5.1-6.2-1.4-5.2 3.8-5.3-2.9-5.8.7-2.8-5.4-5.4-3.1.7-6.1-3.4-5 2.5-5.7-.9-5.8 5.4-3.1 2.7-5.3 6-.4Z" />
      </svg>
    ),
  },
  {
